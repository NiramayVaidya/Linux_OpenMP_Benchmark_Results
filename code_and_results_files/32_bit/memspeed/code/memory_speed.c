/*
gcc memory_speed.c cpuidc.o cpuida.o -lrt -lc -lm -O3 -o memory_speed32
./memory_speed32

gcc memory_speed.c cpuidc.o cpuida.o  -lrt -lc -lm -O3 -fopenmp -o memory_speed32OMP
./memory_speed32OMP

Affinity Setting
taskset 0x00000001 ./memory_speed32OMP

gcc memory_speed.c cpuidc64.o cpuida64.o -lrt -lc -lm -O3 -o memory_speed64
./memory_speed64

gcc memory_speed.c cpuidc64.o cpuida64.o -lrt -lc -lm -O3 -mavx -o memory_speed64AVX
./memory_speed64AVX

gcc memory_speed.c cpuidc64.o cpuida64.o -lrt -lc -lm -O3 -mavx -fopenmp -o memory_speed64AVXOMP
./memory_speed64AVXOMP

gcc memory_speed.c cpuidc64.o cpuida64.o -lrt -lc -lm -O3 -fopenmp -o memory_speed64OMP
./memory_speed64OMP
...
int main()
{
    ...
    fprintf(outfile, "     Memory Reading Speed Test %s \n", version);
    fprintf(outfile, "\n               Start of test %s\n", timeday);
